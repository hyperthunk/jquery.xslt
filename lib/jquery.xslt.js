        ...
        xslt : {
			...
			preCompile: function(data) {
				...
				if (jQuery.browser.mozilla) {
					...
					var includes = jQuery.grep(root.getElementsByTagName('include'), function(e, _) { 
					...
					jQuery.each(includes, function(_, elem) {
						...
						var incl = "<" + xslns + ':include href="' + href + '" />' + ' -- inlined';
						var parent = elem.parentNode;
						parent.insertBefore(doc.createComment(incl), elem);
